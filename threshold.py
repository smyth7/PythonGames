...
training_paths = pathlib.Path(
    '/Users/Paul/Dropbox/Work/Kaggle_Nuclei/Kaggle_Nuclei_Counting/1_Data/stage1_train/').glob('*/images/*.png')
...
testing = pathlib.Path('/Users/Paul/Dropbox/Work/Kaggle_Nuclei/Kaggle_Nuclei_Counting/1_Data/stage1_test/').glob('*/images/*.png')
df = analyze_list_of_images(list(testing))
df.to_csv('/Users/Paul/Dropbox/Work/Kaggle_Nuclei/Kaggle_Nuclei_Counting/submission.csv', index=None)
